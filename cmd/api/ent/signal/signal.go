...
const (
	...
	// FieldAlertMessage holds the string denoting the alertmessage field in the database.
	...
	DecisionsColumn = "signal_decisions"
...
// ForeignKeys holds the SQL foreign-keys that are owned by the Signal type.
